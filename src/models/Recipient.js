...
Recipient.init(
  {
    ...
    responseSpeed: { type: DataTypes.STRING, allowNull: true, defaultValue: null },
    averageResponseMinutes: { type: DataTypes.INTEGER, allowNull: true, defaultValue: null },
    collaborationActivity: { type: DataTypes.STRING, allowNull: true, defaultValue: null },
